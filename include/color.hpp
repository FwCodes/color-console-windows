...
namespace hue
{
    ...
    inline std::ostream & gray(std::ostream & os)                  { set_text("e");          return os; }
    ...
    inline std::ostream & on_gray(std::ostream & os)               { set_background("e");    return os; }
    ...
    inline std::ostream & black_on_gray(std::ostream & os)                { set("k", "e");   return os; }
    ...
    inline std::ostream & blue_on_gray(std::ostream & os)                 { set("b", "e");   return os; }
    ...
    inline std::ostream & green_on_gray(std::ostream & os)                { set("g", "e");   return os; }
    ...
    inline std::ostream & aqua_on_gray(std::ostream & os)                 { set("a", "e");   return os; }
    ...
    inline std::ostream & red_on_gray(std::ostream & os)                  { set("r", "e");   return os; }
    ...
    inline std::ostream & purple_on_gray(std::ostream & os)               { set("p", "e");   return os; }
    ...
    inline std::ostream & yellow_on_gray(std::ostream & os)               { set("y", "e");   return os; }
    ...
    inline std::ostream & white_on_gray(std::ostream & os)                { set("w", "e");   return os; }
    ...
    inline std::ostream & gray_on_black(std::ostream & os)                { set("e", "k");   return os; }
    inline std::ostream & gray_on_blue(std::ostream & os)                 { set("e", "b");   return os; }
    inline std::ostream & gray_on_green(std::ostream & os)                { set("e", "g");   return os; }
    inline std::ostream & gray_on_aqua(std::ostream & os)                 { set("e", "a");   return os; }
    inline std::ostream & gray_on_red(std::ostream & os)                  { set("e", "r");   return os; }
    inline std::ostream & gray_on_purple(std::ostream & os)               { set("e", "p");   return os; }
    inline std::ostream & gray_on_yellow(std::ostream & os)               { set("e", "y");   return os; }
    inline std::ostream & gray_on_white(std::ostream & os)                { set("e", "w");   return os; }
    inline std::ostream & gray_on_gray(std::ostream & os)                 { set("e", "e");   return os; }
    inline std::ostream & gray_on_light_blue(std::ostream & os)           { set("e", "lb");  return os; }
    inline std::ostream & gray_on_light_green(std::ostream & os)          { set("e", "lg");  return os; }
    inline std::ostream & gray_on_light_aqua(std::ostream & os)           { set("e", "la");  return os; }
    inline std::ostream & gray_on_light_red(std::ostream & os)            { set("e", "lr");  return os; }
    inline std::ostream & gray_on_light_purple(std::ostream & os)         { set("e", "lp");  return os; }
    inline std::ostream & gray_on_light_yellow(std::ostream & os)         { set("e", "ly");  return os; }
    inline std::ostream & gray_on_bright_white(std::ostream & os)         { set("e", "bw");  return os; }
    ...
    inline std::ostream & light_blue_on_gray(std::ostream & os)           { set("lb", "e");  return os; }
    ...
    inline std::ostream & light_green_on_gray(std::ostream & os)          { set("lg", "e");  return os; }
    ...
    inline std::ostream & light_aqua_on_gray(std::ostream & os)           { set("la", "e");  return os; }
    ...
    inline std::ostream & light_red_on_gray(std::ostream & os)            { set("lr", "e");  return os; }
    ...
    inline std::ostream & light_purple_on_gray(std::ostream & os)         { set("lp", "e");  return os; }
    ...
    inline std::ostream & light_yellow_on_gray(std::ostream & os)         { set("ly", "e");  return os; }
    ...
    inline std::ostream & bright_white_on_gray(std::ostream & os)         { set("bw", "e");  return os; }
...
namespace dye
{
    ...
    template<typename T> R<T> aqua_on_gray(T t)                 { return R<T> { S<T>(t, "a", "e") }; }
    ...
    template<typename T> R<T> gray_on_aqua(T t)                 { return R<T> { S<T>(t, "e", "a") }; }
    ...
    template<typename T> R<T> gray_on_light_aqua(T t)           { return R<T> { S<T>(t, "e", "la") }; }
    ...
    template<typename T> R<T> gray_on_bright_white(T t)         { return R<T> { S<T>(t, "e", "bw") }; }
    ...
    template<typename T> R<T> light_aqua_on_gray(T t)           { return R<T> { S<T>(t, "la", "e") }; }
    ...
    template<typename T> R<T> bright_white_on_gray(T t)         { return R<T> { S<T>(t, "bw", "e") }; }
